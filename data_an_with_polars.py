...
df = pl.read_csv('/Users/annawilliams/Desktop/polarsDataAnAdv/sales.csv')
print(df)
...
# Calculate a new column 'sales_diff' which is the difference
# between 'sales' and the mean sales
